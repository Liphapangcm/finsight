...
def explain(feature_df: pd.DataFrame) -> SHAPExplanation:
    ...
    sorted_feat = [FEATURE_LABELS.get(FEATURE_COLUMNS[i], FEATURE_COLUMNS[i])
                   for i in indices]
...
def get_top_negative_features(explanation: SHAPExplanation,
...
def get_score_narrative(
    ...
    if top_neg:
        ...
        weakness_msg = (f" The biggest drag on your score is "
