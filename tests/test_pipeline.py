...
def test_healthy_profile():
    ...
    inp = AssessmentInput(
        ...
        transport_expense=800, utilities_expense=500, other_expense=700,
...
def test_high_risk_profile():
    ...
    inp = AssessmentInput(
        ...
        transport_expense=500, utilities_expense=400, other_expense=600,
    ...
    print(f"  ✅ High-risk profile → Score: {result.credit_score} ({result.score_band})")
...
def test_validation_catches_bad_input():
    ...
    inp = AssessmentInput(
        ...
        utilities_expense=0, other_expense=0,
        total_debt=0, num_active_loans=0,
        has_defaulted=False, payment_regularity="always",
        has_savings=False, monthly_savings=0,
        mobile_money_frequency="weekly",
    )
...
def test_recommendations_generated():
    ...
    inp = AssessmentInput(
        ...
        transport_expense=600, utilities_expense=400, other_expense=800,
